...
const Shipyard = () => {
  ...
  const [handleViperSwarmClick] = useModal(<ShipCardModal shipclass="Viper Swarm" />)
        ...
        <BodyWrapper>
          ...
          <LeftCol>
            <ShipClassMenu>
              ...
              <ShipClassCard src={viperSwarmCard} alt="viper Swarm" role="button" onClick={handleViperSwarmClick} />
